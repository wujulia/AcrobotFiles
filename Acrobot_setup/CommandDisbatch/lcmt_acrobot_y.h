...
/**
 * Create a deep copy of a lcmt_acrobot_y.
 * When no longer needed, destroy it with lcmt_acrobot_y_destroy()
 */
lcmt_acrobot_y* lcmt_acrobot_y_copy(const lcmt_acrobot_y* to_copy);

/**
 * Destroy an instance of lcmt_acrobot_y created by lcmt_acrobot_y_copy()
 */
void lcmt_acrobot_y_destroy(lcmt_acrobot_y* to_destroy);
 ...
 * lcmt_acrobot_y is received.
 */
typedef void(*lcmt_acrobot_y_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmt_acrobot_y *msg, void *userdata);

/**
 * Publish a message of type lcmt_acrobot_y using LCM.
 *
 ...
 */
int lcmt_acrobot_y_publish(lcm_t *lcm, const char *channel, const lcmt_acrobot_y *msg);

/**
 * Subscribe to messages of type lcmt_acrobot_y using LCM.
 *
 ...
 */
lcmt_acrobot_y_subscription_t* lcmt_acrobot_y_subscribe(lcm_t *lcm, const char *channel, lcmt_acrobot_y_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lcmt_acrobot_y_subscribe()
 */
...
/**
 * Encode a message of type lcmt_acrobot_y into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to lcmt_acrobot_y_encoded_size().
...
/**
 * Decode a message of type lcmt_acrobot_y from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with lcmt_acrobot_y_decode_cleanup().
 *
 ...
 */
int lcmt_acrobot_y_decode(const void *buf, int offset, int maxlen, lcmt_acrobot_y *msg);

/**
 * Release resources allocated by lcmt_acrobot_y_decode()
 * @return 0
 */
int lcmt_acrobot_y_decode_cleanup(lcmt_acrobot_y *p);

/**
 * Check how many bytes are required to encode a message of type lcmt_acrobot_y
 */
