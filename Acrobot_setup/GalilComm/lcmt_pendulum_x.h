...
/**
 * Create a deep copy of a lcmt_pendulum_x.
 * When no longer needed, destroy it with lcmt_pendulum_x_destroy()
 */
lcmt_pendulum_x* lcmt_pendulum_x_copy(const lcmt_pendulum_x* to_copy);

/**
 * Destroy an instance of lcmt_pendulum_x created by lcmt_pendulum_x_copy()
 */
void lcmt_pendulum_x_destroy(lcmt_pendulum_x* to_destroy);
 ...
 * lcmt_pendulum_x is received.
 */
typedef void(*lcmt_pendulum_x_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmt_pendulum_x *msg, void *userdata);

/**
 * Publish a message of type lcmt_pendulum_x using LCM.
 *
 ...
 */
int lcmt_pendulum_x_publish(lcm_t *lcm, const char *channel, const lcmt_pendulum_x *msg);

/**
 * Subscribe to messages of type lcmt_pendulum_x using LCM.
 *
 ...
 */
lcmt_pendulum_x_subscription_t* lcmt_pendulum_x_subscribe(lcm_t *lcm, const char *channel, lcmt_pendulum_x_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lcmt_pendulum_x_subscribe()
 */
...
/**
 * Encode a message of type lcmt_pendulum_x into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to lcmt_pendulum_x_encoded_size().
...
/**
 * Decode a message of type lcmt_pendulum_x from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with lcmt_pendulum_x_decode_cleanup().
 *
 ...
 */
int lcmt_pendulum_x_decode(const void *buf, int offset, int maxlen, lcmt_pendulum_x *msg);

/**
 * Release resources allocated by lcmt_pendulum_x_decode()
 * @return 0
 */
int lcmt_pendulum_x_decode_cleanup(lcmt_pendulum_x *p);

/**
 * Check how many bytes are required to encode a message of type lcmt_pendulum_x
 */
